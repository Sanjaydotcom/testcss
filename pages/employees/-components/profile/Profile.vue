...
import StaffExit from "./StaffExit.vue";
...
const tabs = [
  ...
  { name: "Appraisal", href: "#", current: false },
];
const team = [
  {
...
export default {
  ...
  // props: ["editGeneralButtonClick", "editEmployeeButtonClick"],
  created() {
  ...
  methods: {
    async fetchEmployeeProfile() {
      ...
      const user = employeeList.filter(function (e) {
        return e.id == (params.id == "me" ? 1 : params.id);
      });
      this.profile = user[0];
    },
  },
  ...
  <div>
      ...
      <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
        <div class="sm:col-span-1">
          ...
          <dd class="mt-1 text-sm text-gray-900">
            {{ profile.details?.contact?.primaryContact }}
          </dd>
        </div>
        <div class="sm:col-span-1">
          <dt class="text-sm font-medium text-gray-500">Title</dt>
          <dd class="mt-1 text-sm text-gray-900">
            {{ profile.details?.employment?.designation }}
          </dd>
        </div>
        <div class="sm:col-span-1">
          <dt class="text-sm font-medium text-gray-500">Location</dt>
          <dd class="mt-1 text-sm text-gray-900">
            {{ profile.details?.employment?.branch }}
          </dd>
        </div>
        <div class="sm:col-span-1">
          <dt class="text-sm font-medium text-gray-500">Salary</dt>
          <dd class="mt-1 text-sm text-gray-900">
            {{ profile.details?.employment?.grossSalary }}
          </dd>
        </div>
        <div class="sm:col-span-1">
          <dt class="text-sm font-medium text-gray-500">Email</dt>
          <dd class="mt-1 text-sm text-gray-900">
            {{ profile.details?.contact?.personalMail }}
          </dd>
        </div>
        <div class="sm:col-span-1">
          <dt class="text-sm font-medium text-gray-500">Company Mail</dt>
          <dd class="mt-1 text-sm text-gray-900">
            {{ profile.details?.contact?.companyMail }}
          </dd>
        </div>
        <div class="sm:col-span-1">
          <dt class="text-sm font-medium text-gray-500">Department</dt>
          <dd class="mt-1 text-sm text-gray-900">
            {{ profile.details?.employment?.department }}
          </dd>
        </div>
        <div class="sm:col-span-1">
          <dt class="text-sm font-medium text-gray-500">Birthday</dt>
          <dd class="mt-1 text-sm text-gray-900">22/02/2000</dd>
        </div>
    ...
    <div>
      <div class="mx-auto mt-8 max-w-5xl px-4 sm:px-6 lg:px-8">
        <Employment :employment="profile.details.employment" :id="profile.id" />
      </div>
      <Contact :contact="profile.details.contact" :id="profile.id" />

      <Education
        @updateState="fetchEmployeeProfile"
        :educations="profile.details.education"
        :id="profile.id"
      />
      <Experience
        @updateState="fetchEmployeeProfile"
        :experience="profile.details.WorkExperience"
        :id="profile.id"
      />
