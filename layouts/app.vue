...
const navigation = [
  ...
  { name: "Employees", href: "/employees/1", icon: UserIcon, current: false },
];
...
<template>
  ...
  <div class="h-full flex">
              ...
              <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                <div class="flex-shrink-0 flex items-center px-4">
                  <img
                    ...
                    alt="LogistiX"
                  />
                  <p class="ml-2 text-2xl text-gray-700 font-medium">
                    LogistiX
                  </p>
                </div>
    ...
    <div class="hidden lg:flex lg:flex-shrink-0 min-h-screen">
      <div class="flex flex-col w-64">
        <!-- Sidebar component, swap this element with another sidebar if you like -->
        <div
          class="flex-1 flex flex-col min-h-screen- border-r border-gray-200"
        >
          <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <a>
              <div class="flex items-center flex-shrink-0 px-4 cursor-pointer">
                <img
                  class="h-8 w-auto"
                  src="https://avatars.githubusercontent.com/u/103851215"
                  alt="LogistiX"
                />
                <p class="ml-2 text-2xl text-gray-700 font-medium">LogistiX</p>
              </div>
            </a>
          ...
          <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
            <a href="/employees/me" class="flex-shrink-0 w-full group block">
              <div class="flex items-center">
                <div>
                  <img
